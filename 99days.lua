...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/goondiety/ESP-LIB/refs/heads/main/uiloader.txt"))()
...
itemsDropdown.update = itemsDropdown.update or function(self) end
